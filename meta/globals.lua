...
---@alias SendVarFunc fun(variantList:Variant):nil|fun(variantList:Variant, packet:PacketRaw):nil|fun(variantList:Variant, use_netID?:boolean, netID?:integer, value?:integer):nil
